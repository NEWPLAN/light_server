...
int socketBindListen(int port)
{
    ...
    {
        std::cerr << "port error: should be in range of (0, 65535), you port is: " << port << std::endl;
        return -1;
    }
    ...
    {
        std::cerr << "Init sock errors..." << std::endl;
        return -1;
    }
    ...
    {
        std::cerr << "Bind port errors..." << std::endl;
        return -1;
    }

    if (::listen(listenFd, 2048) == -1)
    {
        std::cerr << "Listen errors..." << std::endl;
        return -1;
    }
